 ...
 * Use the {@link TabHost#newInstance} factory method to
...
public class TabHost extends Fragment  {
    ...
    public static TabHost newInstance(String param1, String param2) {
        TabHost fragment = new TabHost();
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof TabHost.inicializarTabHost) {
            mListener = (TabHost.inicializarTabHost) context;
        } else {
